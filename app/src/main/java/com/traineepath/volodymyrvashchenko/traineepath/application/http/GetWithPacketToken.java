 ...
 * with PacketAccessToken as a Bearer value.
 *
 * @see PacketAccessToken
 */
public class GetWithPacketToken extends JsonObjectRequest {

    public GetWithPacketToken(int method, String url, JSONObject j, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
